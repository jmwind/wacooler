...
- (done) should add autofocus: true to email field in login
- infini scroll posts on home page
- follow/unfollow in users list (refactor follow buttons and logic)
- add @mentions
- web sockets for live updates
- social login (Facebook and Google)
- add search with elastic search
- allow multiple nodes (caching?), cdn?
